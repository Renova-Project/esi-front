...
export default function HeroSection({ lab }) {
    ...
    return <section>
        <div className="text-white" style={{ background: "url('/labs/hero-bg.png') no-repeat", backgroundSize: "cover" }}>
            ...
            <div className="container py-10 lg:py-20 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div className="md:mt-56 space-y-4 bg-[#273E5A44] backdrop-blur-md p-4 border boder-white">
