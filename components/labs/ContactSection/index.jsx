    ...
    return <section className="bg-grayishBg">
        <div className="container p-10 lg:py-20 grid grid-cols-2">
            <div className="space-y-8">
                <h1 className={cn(sourceSerif.className, "font-bold text-2xl lg:text-3xl")}>Contacez nous</h1>
            ...
            <div>
                <form className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea maxLength={255} rows={3} className="text-lg border border-gray-300 px-4 py-2 w-full resize-none" type="text" name="name" placeholder="Entrez votre message" />
                    </div>
