      ...
      <div className="w-full h-auto flex items-center flex-1 rounded-lg border-2">
        ...
        <div className="h-full py-6 px-4 w-[60%]">
          <p className="text-[#0061B1] mb-4 text-lg lg:text-xl font-bold">
            Rencontres directes avec les futurs diplômés
          </p>
          {/* we must slice the text in the small screens */}
          <p className={`text-[#212124] ${workSans.className}`}>
            Organisez des journées de recrutement, des présentations
            d’entreprise, et des ateliers spécifiques sur le campus pour
            rencontrer les étudiants et leur présenter les opportunités de
            carrière...
          </p>
        </div>
      </div>
        ...
        <div className="container py-16">
          ...
          <div className="flex justify-center">
            ...
            <div className="max-w-[35rem] flex flex-col gap-6">
              ...
              <div className="w-full flex items-center gap-6 p-5 bg-[#2C6DC5] text-white text-sm lg:text-base font-bold">
                <Image
                  src={"/mdi_email-certified-outline.svg"}
                  alt="/"
                  width={30}
                  height={30}
                />
