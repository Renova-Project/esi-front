    ...
    <div>
        ...
        <div className='flex items-center lg:hidden'>
           <div className='w-1/3 flex justify-center py-4 bg-honolulu text-white text-sm md:text-base font-semibold border-white border-r-2'>
            <Link href={'/partners/recruitment'}>{t1("nav.recruitment.recruitmentSm")}</Link>
           </div>
        ...
        <div className='container pt-6 pb-10'>
             <div className='text-center'>
                <h1 className={`text-[#0061B1] text-xl lg:text-2xl font-bold ${inter.className}`}>{t2("title")}</h1>
             </div>
                ...
                <div className='max-w-[25rem]'>
                    ...
                    <form className='flex flex-col gap-6'>
                        ...
                        <select  
                          ...
                          className='w-full text-[#555555] bg-[#EAEAEA] p-2 text-sm focus:outline-none'
                          >
                            <option value={t2("organisationInfos.type")} disabled selected hidden>{t2("organisationInfos.type")}</option>
                        ...
                        <select  
                          ...
                          className='w-full text-[#555555] bg-[#EAEAEA] p-2 text-sm focus:outline-none'
                          >
                            <option value={t2("organisationInfos.sector")} disabled selected hidden>{t2("organisationInfos.sector")}</option>
                            <option value="proposition1">Proposition 1</option>
                            <option value="proposition2">Proposition 2</option>                          
                        </select>
                        <select  
                          ...
                          className='w-full text-[#555555] bg-[#EAEAEA] p-2 text-sm focus:outline-none'
                          >
                            <option value={t2("organisationInfos.size")} disabled selected hidden>{t2("organisationInfos.size")}</option>
                            <option value="proposition1">Proposition 1</option>
                            <option value="proposition2">Proposition 2</option>                          
                        </select>
                    </form>
                ...
                <div className='max-w-[25rem]'>
                    ...
                    <form className='flex flex-col gap-6'>
                        ...
                        <select  
                          ...
                          className='w-full text-[#555555] bg-[#EAEAEA] p-2 text-sm focus:outline-none'
                          >
                            <option value={t2("contactDetails.pays")} disabled selected hidden>{t2("contactDetails.pays")}</option>
                ...
                <div className='max-w-[25rem]'>
                    ...
                    <form className='flex flex-col gap-6'>
                        <select  
                          ...
                          className='w-full text-[#555555] bg-[#EAEAEA] p-2 text-sm focus:outline-none'
                          >
                            <option value={t2("partnershipObjectives.areasOfInterest")} disabled selected hidden>{t2("partnershipObjectives.areasOfInterest")}</option>
                            <option value="proposition1">Proposition 1</option>
                            <option value="proposition2">Proposition 2</option>                          
                        </select>
                        <select  
                          ...
                          className='w-full text-[#555555] bg-[#EAEAEA] p-2 text-sm focus:outline-none'
                          >
                            <option value={t2("partnershipObjectives.type")} disabled selected hidden>{t2("partnershipObjectives.type")}</option>
                            <option value="proposition1">Proposition 1</option>
                            <option value="proposition2">Proposition 2</option>                          
                        </select>
                        <input 
                        ...
                        <div className='w-full flex justify-between items-center text-[#555555] bg-[#EAEAEA] p-2 text-sm'>
                          ...
                          <label for='upload-btn' className='w-28 cursor-pointer flex items-center justify-between bg-gradient-to-r from-btnGradientStart via-btnGradientStart via-30% to-[#2e6dc6] p-2 text-sm text-white font-semibold'>
