    ...
    <div>
      ...
      <div className="container py-10 max-w-[40rem]">
        <div className="text-center">
          <h1
            className={`text-[#0061B1] text-lg md:text-2xl pb-4 font-bold ${inter.className}`}
          >
            {t2("title")}
          </h1>
          <p className="text-darkgrey font-semibold text-lg pb-6">
            {t2("text")}
          </p>
        </div>
        <div className="bg-[#EFEFEF] py-12 text-center">
          ...
          <div className="flex items-center justify-center">
            ...
            <label
              for="upload-btn"
              className="cursor-pointer flex items-center gap-3 py-2 px-4 bg-gradient-to-r from-btnGradientStart via-btnGradientStart via-30% to-[#2e6dc6] text-sm text-white font-semibold"
            >
              <span>Select file</span>
              <ArrowUpTrayIcon className="w-6 h-6" />
            </label>
          </div>
          <p className="text-darkgrey text-xs font-semibold py-4">
            Maximum upload file size: 200MB
          </p>
          <Link
            className="text-honolulu text-sm font-bold underline"
            href={"/partners/recruitment/diplomas_verification/many"}
          >
            {t2("link")}
          </Link>
        </div>
        <p className="text-center text-darkgrey font-semibold py-4">
          {t2("or")}
        </p>
        <div className="flex justify-center pb-6">
          <Link
            className="py-4 px-5 text-center font-bold text-[#0061B1] border-[#0061B1] border-[1px]"
            href={"/partners/recruitment/diplomas_verification/many"}
          >
            {t2("toInput")}
          </Link>
        ...
        <div className="flex justify-center">
          <Link
            className="py-4 px-8 text-white text-sm bg-gradient-to-r from-btnGradientStart via-btnGradientStart via-30% to-[#2e6dc6]"
            href={""}
          >
            {t2("verify")}
          </Link>
